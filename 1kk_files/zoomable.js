...
(function (Carbon) {
    ...
    var Zoomable = (function () {
        function Zoomable() {
            ...
            _.trigger(this.zoomerEl, 'zoomer:create', {});
        ...
        Zoomable.prototype.open = function (element) {
            ...
            _.trigger(this.zoomerEl, 'zoomer:open', {});
            this.zoomIn();
        };
        ...
        Zoomable.prototype.next = function (timestamp) {
            ...
            if (!this.timestamp) {
                ...
                this.step(p);
                if (elapsed >= duration) {
                    this.zoomerEl.classList.remove('open', 'closing');
        ...
        Zoomable.prototype.zoomOut = function () {
            ...
            _.trigger(this.zoomerEl, 'zoomer:close', { reload: true });
            requestAnimationFrame(this.next.bind(this));
        };
        return Zoomable;
    }());
